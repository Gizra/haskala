...
Clone the project from [GitHub](https://github.com/Gizra/haskala).
...
6. Makes a symlink within the /www/profiles directory to the /haskala
   directory.
7. Run the Drupal installer (Drush) using the Haskala profile.
